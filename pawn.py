...
class Pawn(ChessPiece):
    ...
    def __str__(self):
        return f"This is a {'White' if self.player == Player.WHITE else 'Black'} pawn."
            ...
            # the other way on the board.
                ...
                if move.to_row == move.from_row + 1 and move.to_col == move.from_col:
                    ...
                    if end_spot is not None:
                        ...
                        return True
                return False
            # if player color is not black or white, raise an error.
            else:
                raise ValueError("That is not a valid player color.")
        else:
            return False
